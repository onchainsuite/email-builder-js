...
const EDITOR_DICTIONARY = buildBlockConfigurationDictionary({
    ...
    Image: {
        ...
        Component: (data) => {
            var _d, _e;
            const props = Object.assign(Object.assign({}, data), { props: Object.assign(Object.assign({}, data.props), { url: (_e = (_d = data.props) === null || _d === void 0 ? void 0 : _d.url) !== null && _e !== void 0 ? _e : 'https://placehold.co/600x400@2x/F8F8F8/CCC?text=Your%20image' }) });
