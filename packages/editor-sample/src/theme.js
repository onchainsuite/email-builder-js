...
const STANDARD_FONT_FAMILY = '-apple-system, BlinkMacSystemFont, Instrument Sans, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"';
